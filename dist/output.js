  ...
  var runQuery = function (__dict_CanSwitchContext_1) {
      return function (db) {
          return function (_9) {
              ...
              var tableName = Lovefield_Internal_Exists.runExists2(function (_3) {
                  return _3.value0;
              });
      ...
      return function (_5) {
          return Query(Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(newAlias)(function (_2) {
              return Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.modify(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (qs) {
                  var _93 = {};
                  for (var _94 in qs) {
                      if (qs.hasOwnProperty(_94)) {
                          _93[_94] = qs[_94];
                      };
                  };
                  _93.query = new Lovefield_Internal_PrimExpr.Times(qs.query, new Lovefield_Internal_PrimExpr.BaseTable(_2, Lovefield_Internal_Exists.mkExists2(_5)));
                  return _93;
              }))(function () {
...
(function(exports) {
  ...
  var name = function (_8) {
      return Data_Identity.runIdentity(_8.name);
  };
  ...
  var namesCanSwitchContext = new Lovefield_CanSwitchContext.CanSwitchContext(function (f) {
      return function (_9) {
          return mkNames(f(_9.id))(f(_9.name))(f(_9.age))(f(_9.bag));
      };
  });
  var query1 = Lovefield_Query[">>-"](namesCanSwitchContext)(Lovefield_Query.from(namesCanSwitchContext)(names))(function (_4) {
      return Lovefield_Query[">>-"](namesCanSwitchContext)(Lovefield_Query.where_(Lovefield_Query[".==."](_4.name)(_4.name)))(function (_3) {
          return Lovefield_Query.select(_4);
      });
  });
  var query2 = Lovefield_Query[">>-"](namesCanSwitchContext)(Lovefield_Query.from(namesCanSwitchContext)(names))(function (_7) {
      return Lovefield_Query[">>-"](namesCanSwitchContext)(Lovefield_Query.from(namesCanSwitchContext)(names))(function (_6) {
          return Lovefield_Query[">>-"](namesCanSwitchContext)(Lovefield_Query.where_(Lovefield_Query[".==."](_7.name)(_6.name)))(function (_5) {
