...
(function(exports) {
  ...
  var columnName = function (_5) {
      var impl = function (cdu) {
          ...
          throw new Error("Failed pattern match at Lovefield line 136, column 5 - line 137, column 5: " + [ cdu.constructor.name ]);
      };
  ...
  var addConstraint = function (tb) {
      return function (constraint) {
          ...
          throw new Error("Failed pattern match at Lovefield line 170, column 1 - line 175, column 1: " + [ constraint.constructor.name ]);
      };
  };
  var addColumn = function (tb) {
      return function (_6) {
          var impl = function (cdu) {
              ...
              throw new Error("Failed pattern match at Lovefield line 155, column 5 - line 156, column 5: " + [ cdu.constructor.name ]);
          };
  ...
  var buildTable = function (sb) {
      return function (_7) {
          ...
          var columnDescriptions = Prelude.map(Prelude.functorArray)(function (_80) {
              return Data_Foreign.unsafeFromForeign(Data_Either_Unsafe.fromRight(Data_Foreign_Index["!"](Data_Foreign_Index.indexString)(foreignColumns)(_80)));
          })(ks);
          var columnActions = function (tb) {
              return Data_Array.foldM(Control_Monad_Eff.monadEff)(addColumn)(tb)(columnDescriptions);
          };
          return function __do() {
              var _3 = $foreign.createTableNative(_7.value0, sb)();
  ...
  var connect = function (_8) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)($foreign.createNative(_8.value0, _8.value1)))(function (_4) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(Lovefield_Internal_Exists.runExists2(buildTable(_4)))(_8.value2)))(function () {
...
})(PS["Lovefield.QueryExpr"] = PS["Lovefield.QueryExpr"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var $foreign = PS["Lovefield.QueryExpr"];
  var Prelude = PS["Prelude"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Control_Monad_Eff_Exception = PS["Control.Monad.Eff.Exception"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  ...
  var From = (function () {
      function From(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      From.create = function (value0) {
          return function (value1) {
              return new From(value0, value1);
          };
      };
      return From;
  })();
  ...
  var fromExpr = function (table) {
      return Lovefield_Internal_Exists.mkExists2(new From(table, Prelude.id(Data_Leibniz.categoryLeibniz)));
  };
  var queryTable = function (table) {
      return new Pure(fromExpr(table));
  };
  var from = Data_Function.runFn3($foreign.fromNative);
  ...
  var runQuery = function (db) {
      return function (schema) {
          return function (_0) {
              var impl = function (etu) {
                  return exec(from(db)(etu.value0.value0)($foreign.selectAll(db)));
              };
              return Lovefield_Internal_Exists.runExists2(impl)(_0.value0);
          };
      };
  };
  exports["From"] = From;
...
(function(exports) {
  ...
  var Lovefield = PS["Lovefield"];
  var Lovefield_ColumnDescription = PS["Lovefield.ColumnDescription"];
  var Lovefield_QueryExpr = PS["Lovefield.QueryExpr"];
  var Lovefield_Internal_Exists = PS["Lovefield.Internal.Exists"];     
  ...
  var query2 = Lovefield_QueryExpr.queryTable(names);
  var schema = new Lovefield.Schema("MyDB", 1, [ Lovefield_Internal_Exists.mkExists2(names) ]);
  var name = function (_2) {
      return Data_Identity.runIdentity(_2.name);
  };
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.print(Prelude.showString)("connected")))(function () {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Lovefield.insertOrReplace(_1)(schema)(names)([ value ]))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.print(Prelude.showString)("inserted")))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Lovefield_QueryExpr.runQuery(_1)(schema)(query2))(function (_0) {
