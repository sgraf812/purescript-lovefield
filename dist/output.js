...
(function(exports) {
  ...
  var $greater$greater$minus = function (__dict_CanSwitchContext_0) {
      return function (_4) {
          return function (continuation) {
              return Query(Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(_4)(function (_1) {
                  var _13 = continuation(_1);
                  return _13;
              }));
          };
      };
  };
  var where_ = function (_6) {
      return Query(Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.modify(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (qs) {
          var _15 = {};
          for (var _16 in qs) {
              if (qs.hasOwnProperty(_16)) {
                  _15[_16] = qs[_16];
              };
          };
          _15.query = new Lovefield_Internal_PrimExpr.Restrict(_6, qs.query);
          return _15;
      }))(function () {
  ...
  var normalize = function (originalQuery) {
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Times && originalQuery.value0 instanceof Lovefield_Internal_PrimExpr.EmptyQuery) {
          return normalize(originalQuery.value1);
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Times && originalQuery.value1 instanceof Lovefield_Internal_PrimExpr.EmptyQuery) {
          return normalize(originalQuery.value0);
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Times && originalQuery.value0 instanceof Lovefield_Internal_PrimExpr.BaseTable) {
          return new Lovefield_Internal_PrimExpr.Times(originalQuery.value0, normalize(originalQuery.value1));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Times && originalQuery.value1 instanceof Lovefield_Internal_PrimExpr.BaseTable) {
          return new Lovefield_Internal_PrimExpr.Times(originalQuery.value1, normalize(originalQuery.value0));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Times && originalQuery.value0 instanceof Lovefield_Internal_PrimExpr.Project) {
          return normalize(new Lovefield_Internal_PrimExpr.Project(originalQuery.value0.value0, new Lovefield_Internal_PrimExpr.Times(originalQuery.value0.value1, originalQuery.value1)));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Times && originalQuery.value1 instanceof Lovefield_Internal_PrimExpr.Project) {
          return normalize(new Lovefield_Internal_PrimExpr.Project(originalQuery.value1.value0, new Lovefield_Internal_PrimExpr.Times(originalQuery.value0, originalQuery.value1.value1)));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Times && originalQuery.value0 instanceof Lovefield_Internal_PrimExpr.Restrict) {
          return normalize(new Lovefield_Internal_PrimExpr.Restrict(originalQuery.value0.value0, new Lovefield_Internal_PrimExpr.Times(originalQuery.value0.value1, originalQuery.value1)));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Times && originalQuery.value1 instanceof Lovefield_Internal_PrimExpr.Restrict) {
          return normalize(new Lovefield_Internal_PrimExpr.Restrict(originalQuery.value1.value0, new Lovefield_Internal_PrimExpr.Times(originalQuery.value0, originalQuery.value1.value1)));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Times && originalQuery.value0 instanceof Lovefield_Internal_PrimExpr.Times) {
          return normalize(new Lovefield_Internal_PrimExpr.Times(originalQuery.value0.value0, new Lovefield_Internal_PrimExpr.Times(originalQuery.value0.value1, originalQuery.value1)));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Times) {
          return new Lovefield_Internal_PrimExpr.Times(normalize(originalQuery.value0), normalize(originalQuery.value1));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Restrict && originalQuery.value1 instanceof Lovefield_Internal_PrimExpr.Project) {
          return normalize(new Lovefield_Internal_PrimExpr.Project(originalQuery.value1.value0, new Lovefield_Internal_PrimExpr.Restrict(originalQuery.value0, originalQuery.value1.value1)));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Restrict) {
          return new Lovefield_Internal_PrimExpr.Restrict(originalQuery.value0, normalize(originalQuery.value1));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Project && originalQuery.value1 instanceof Lovefield_Internal_PrimExpr.Project) {
          return normalize(new Lovefield_Internal_PrimExpr.Project(Prelude["++"](Data_List.semigroupList)(originalQuery.value0)(originalQuery.value1.value0), originalQuery.value1.value1));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.Project) {
          return new Lovefield_Internal_PrimExpr.Project(originalQuery.value0, normalize(originalQuery.value1));
      };
      if (originalQuery instanceof Lovefield_Internal_PrimExpr.EmptyQuery) {
          return Lovefield_Internal_PrimExpr.EmptyQuery.value;
      };
  ...
  var newAlias = Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity)))(function (_0) {
      return Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.put(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))((function () {
          var _65 = {};
          for (var _66 in _0) {
              if (_0.hasOwnProperty(_66)) {
                  _65[_66] = _0[_66];
              };
          };
          _65.alias = _0.alias + 1 | 0;
          return _65;
      })()))(function () {
  ...
  var exec = function (qb) {
      return Control_Monad_Aff.makeAff(Data_Function.runFn3($foreign.execNative)(qb));
  };
  var runQuery = function (__dict_CanSwitchContext_1) {
      return function (db) {
          return function (_9) {
              var qs = Control_Monad_State.execState(_9)(initialState);
              var build = function (__copy_query) {
                  var query = __copy_query;
                  tco: while (true) {
                      if (query instanceof Lovefield_Internal_PrimExpr.BaseTable) {
                          return Lovefield_Internal_Exists.runExists2(function (_3) {
                              return $foreign.fromNative(db, _3.value0, $foreign.selectAll(db));
                          })(query.value1);
                      };
                      if (query instanceof Lovefield_Internal_PrimExpr.Restrict) {
                          var __tco_query = query.value1;
                          query = __tco_query;
                          continue tco;
                      };
                      throw new Error("Failed pattern match at Lovefield.Query line 190, column 1 - line 196, column 1: " + [ query.constructor.name ]);
                  };
              };
              var execute = function (query) {
                  return exec(build(normalize(query)));
              };
      ...
      return function (_5) {
          return Query(Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(newAlias)(function (_2) {
              return Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.modify(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (qs) {
                  var _80 = {};
                  for (var _81 in qs) {
                      if (qs.hasOwnProperty(_81)) {
                          _80[_81] = qs[_81];
                      };
                  };
                  _80.query = new Lovefield_Internal_PrimExpr.Times(qs.query, new Lovefield_Internal_PrimExpr.BaseTable(_2, Lovefield_Internal_Exists.mkExists2(_5)));
                  return _80;
              }))(function () {
                  return Prelude.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Lovefield_CanSwitchContext.switchContext(__dict_CanSwitchContext_2)(columnDescriptionToExpr(_2))(_5.value2));
              });
          }));
      };
  };
  var binOp = function (op) {
      return function (_7) {
          return function (_8) {
              return new Lovefield_Internal_PrimExpr.BinExpr(op, _7, _8);
          };
      };
  };
...
(function(exports) {
  ...
  var name = function (_4) {
      return Data_Identity.runIdentity(_4.name);
  };
  ...
  var namesCanSwitchContext = new Lovefield_CanSwitchContext.CanSwitchContext(function (f) {
      return function (_5) {
          return mkNames(f(_5.id))(f(_5.name))(f(_5.age))(f(_5.bag));
      };
  });
  var query1 = Lovefield_Query[">>-"](namesCanSwitchContext)(Lovefield_Query.from(namesCanSwitchContext)(names))(function (_3) {
      return Lovefield_Query[">>-"](namesCanSwitchContext)(Lovefield_Query.where_(Lovefield_Query[".==."](_3.name)(_3.name)))(function (_2) {
  ...
  var main = Control_Monad_Aff.launchAff(Prelude.bind(Control_Monad_Aff.bindAff)(Lovefield_Connect.connect(schema))(function (_1) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.print(Prelude.showString)("connected")))(function () {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Lovefield_Insert.insertOrReplace(_1)(schema)(names)([ bert ]))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.print(Prelude.showString)("inserted")))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Lovefield_Query.runQuery(namesCanSwitchContext)(_1)(query1))(function (_0) {
