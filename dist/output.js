...
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var runApp = function (_0) {
      return _0;
  };
  exports["runApp"] = runApp;;
 
})(PS["Lovefield.App"] = PS["Lovefield.App"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var defaultNullable = function (cd) {
      return Lovefield_Internal_Exists.mkExists0(new Nullable(Lovefield_App.runApp(cd), Prelude.id(Data_Leibniz.categoryLeibniz)));
  };
  ...
  var columnName = function (_0) {
      var impl = function (cdu) {
          ...
          throw new Error("Failed pattern match at Lovefield.ColumnDescription line 36, column 5 - line 37, column 5: " + [ cdu.constructor.name ]);
      };
...
(function(exports) {
      ...
      return function (_8) {
          return function (_9) {
              return function (values) {
                  return Control_Monad_Aff.makeAff(Data_Function.runFn5($foreign.insertOrReplaceNative)(db)(_9.value0)(values));
              };
          };
      };
  };
  var addConstraint = function (tb) {
      return function (constraint) {
          ...
          throw new Error("Failed pattern match at Lovefield line 138, column 1 - line 143, column 1: " + [ constraint.constructor.name ]);
      };
  };
          ...
          var impl = function (cdu) {
              ...
              if (cdu instanceof Lovefield_ColumnDescription.Nullable) {
                  return function __do() {
                      ...
                      return $foreign.addNullable([ Lovefield_ColumnDescription.columnName(cdu.value0) ], _0)();
                  };
              };
              throw new Error("Failed pattern match at Lovefield line 123, column 5 - line 124, column 5: " + [ cdu.constructor.name ]);
          };
          return Lovefield_Internal_Exists.runExists0(impl)(_5);
      };
  };
  var buildTable = function (sb) {
      return function (_6) {
          var foreignColumns = Data_Foreign.toForeign(_6.value2);
          ...
          var constraintActions = function (tb) {
              return Data_Array.foldM(Control_Monad_Eff.monadEff)(addConstraint)(tb)(_6.value1);
          };
          var columnDescriptions = Prelude.map(Prelude.functorArray)(function (_61) {
              return Data_Foreign.unsafeFromForeign(Data_Either_Unsafe.fromRight(Data_Foreign_Index["!"](Data_Foreign_Index.indexString)(foreignColumns)(_61)));
          })(ks);
          var columnActions = function (tb) {
              return Data_Array.foldM(Control_Monad_Eff.monadEff)(addColumn)(tb)(columnDescriptions);
          };
          return function __do() {
              var _3 = $foreign.createTableNative(_6.value0, sb)();
  ...
  var connect = function (_7) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)($foreign.createNative(_7.value0, _7.value1)))(function (_4) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(Lovefield_Internal_Exists.runExists2(buildTable(_4)))(_7.value2)))(function () {
...
(function(exports) {
  ...
  var runQuery = function (__dict_CanSwitchContext_2) {
      return function (db) {
          return function (_7) {
              var qs = Control_Monad_State.execState(_7)(initialState);
              var execute = function (__copy_query) {
                  ...
                  tco: while (true) {
                      ...
                      if (query instanceof Lovefield_Internal_PrimExpr.BaseTable) {
                          return Lovefield_Internal_Exists.runExists2(function (_3) {
                              return exec($foreign.fromNative(db, _3.value0, $foreign.selectAll(db)));
                          })(query.value1);
                      };
                      throw new Error("Failed pattern match at Lovefield.Query line 149, column 1 - line 155, column 1: " + [ query.constructor.name ]);
                  };
              };
  ...
  var columnDescriptionToExpr = function (alias) {
      return function (_6) {
          return new Lovefield_Internal_PrimExpr.AttrExpr(alias, Lovefield_ColumnDescription.columnName(_6));
      };
  };
      ...
      return function (_5) {
          return Query(Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(newAlias)(function (_2) {
              return Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.modify(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (qs) {
                  var _30 = {};
                  for (var _31 in qs) {
                      if (qs.hasOwnProperty(_31)) {
                          _30[_31] = qs[_31];
                      };
                  };
                  _30.query = new Lovefield_Internal_PrimExpr.Times(qs.query, new Lovefield_Internal_PrimExpr.BaseTable(_2, Lovefield_Internal_Exists.mkExists2(_5)));
                  return _30;
              }))(function () {
                  return Prelude.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Lovefield_CanSwitchContext.switchContext(__dict_CanSwitchContext_3)(columnDescriptionToExpr(_2))(_5.value2));
              });
          }));
      };
  };
...
(function(exports) {
  ...
  var name = function (_2) {
      return Data_Identity.runIdentity(Lovefield_App.runApp(_2.name));
  };
  ...
  var namesCanSwitchContext = new Lovefield_CanSwitchContext.CanSwitchContext(function (f) {
      return function (_3) {
          return mkNames(f(_3.id))(f(_3.name))(f(_3.age))(f(_3.bag));
      };
  });
  var query1 = Lovefield_Query.from(namesCanSwitchContext)(names);
  var main = Control_Monad_Aff.launchAff(Prelude.bind(Control_Monad_Aff.bindAff)(Lovefield.connect(schema))(function (_1) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.print(Prelude.showString)("connected")))(function () {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Lovefield.insertOrReplace(_1)(schema)(names)([ value ]))(function () {
